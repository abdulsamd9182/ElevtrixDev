    ...
    <section className="relative w-full min-h-screen pt-24 pb-24 overflow-hidden bg-white flex items-center md:items-start md:pt-32">
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-16 z-10 w-full">
        <motion.div initial="hidden" animate="visible" variants={{ hidden: { opacity: 0 }, visible: { opacity: 1, transition: { staggerChildren: 0.15, delayChildren: 0.1 } } }} className="space-y-5 max-w-xl">
          <motion.h1 variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0 } }} className="text-center md:text-left text-4xl md:text-5xl lg:text-6xl font-black tracking-tight leading-[1.1] text-white drop-shadow-xl">
            INTELLIGENT <br />
          ...
          <motion.p variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="text-center md:text-left mx-auto md:mx-0 text-white text-sm md:text-base font-medium leading-relaxed max-w-md drop-shadow-sm">
          ...
          <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="flex flex-wrap gap-3 pt-3 justify-center md:justify-start">
