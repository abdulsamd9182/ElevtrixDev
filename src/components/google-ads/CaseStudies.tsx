...
const insights = [
  {
    id: 1,
    category: "Case Study",
    title: "SaaS Brand: 3x Demo Bookings via Performance Max in 60 Days",
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2670&auto=format&fit=crop"
  },
  {
    id: 2,
    category: "Case Study",
    title: "E-Commerce Store: 8.4x ROAS Through Google Shopping Optimisation",
    image: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=2670&auto=format&fit=crop"
  },
  {
    id: 3,
    category: "Insights",
    title: "Why Your Google Ads Are Losing to Competitors (And How to Fix It)",
    ...
    <section className="w-full border-t border-white/5 py-24">
      <div className="max-w-7xl mx-auto px-8 md:px-16">
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-black tracking-[0.2em] text-white uppercase mb-4">Campaign Breakthroughs</h2>
          <p className="text-gray-500 text-sm font-medium tracking-widest uppercase">Results that speak louder than any pitch deck</p>
        </motion.div>
