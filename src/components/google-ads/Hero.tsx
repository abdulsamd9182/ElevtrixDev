  ...
  return (
    <section className="relative w-full min-h-screen pb-24 overflow-hidden bg-white flex items-center lg:items-start pt-28 md:pt-40">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        >
          <source src="/ad 2.mp4" type="video/mp4" />
        </video>
      </div>
        ...
        >
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400">
              GOOGLE ADS <br className="hidden md:block" /> STRATEGY
            </span>{" "}
          ...
          >
            Data-driven Google Ads (Search, Display & Shopping) campaigns engineered for maximum ROAS, intent-driven targeting, and scalable business growth.
          </motion.p>
