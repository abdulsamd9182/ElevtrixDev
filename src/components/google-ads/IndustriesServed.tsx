...
const industries = [
  {
    ...
    description: "Maximizing high-intent product sales via Shopping, P-Max, and Dynamic Search architectures.",
    icon: ShoppingBag,
  ...
  {
    name: "Real Estate",
    description: "Generating exclusive buyer and seller leads through precision keyword intent and map targeting.",
    icon: Building2,
  ...
  },
  {
    ...
    description: "Policy-compliant patient acquisition campaigns focused on high-trust search vocabulary and local SEO.",
    icon: HeartPulse,
  ...
  },
  {
    ...
    description: "Driving student enrollments and program awareness with full-funnel search and display strategies.",
    icon: GraduationCap,
    color: "from-orange-600 to-red-600",
    stats: "70% Enroll Boost"
  },
  {
    name: "Home Local Services",
    description: "Dominating local search with LSAs and localized bidding for contractors and high-ticket home services.",
    icon: Wrench,
    color: "from-red-600 to-rose-600",
    stats: "3x Call Volume"
  }
];
