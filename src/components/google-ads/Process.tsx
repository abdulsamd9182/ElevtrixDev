...
const processSteps = [
  {
    ...
    description: "Deep dive into your current Google account performance. We analyze high-intent keywords and competitor strategies to build our roadmap.",
    icon: Search,
    color: "from-blue-500 to-cyan-500",
    deliverables: ["Account Deep-Audit", "KPI Mapping", "Keyword Research", "Bidding Strategy"]
  },
  {
    step: "02",
    title: "Account Structure",
    description: "Building the engine. We engineer advanced account architectures (SKAGs/Hagakure) designed for data clarity and AI-driven performance.",
    icon: Layout,
    color: "from-purple-500 to-pink-500",
    deliverables: ["Campaign Hierarchy", "Negative Sculpting", "Ad Copy Creation", "Extension Setup"]
  },
  {
    step: "03",
    title: "Intelligence & Tracking",
    description: "Ensuring data integrity. We deploy multi-touch attribution and Conversion Tracking to ensure Google's AI optimizes for your bottom line.",
    icon: Target,
    color: "from-green-500 to-emerald-500",
    deliverables: ["GTM/GA4 Integration", "Offline Conversions", "Enhanced Conversions", "CAPI Setup"]
  },
  {
    step: "04",
    title: "Launch & Scale",
    description: "The scaling phase. We aggressively monitor bid performance and landing page tests, scaling high-ROAS segments to dominate the niche.",
    icon: TrendingUp,
    color: "from-orange-500 to-red-500",
    deliverables: ["Bid Management", "LPO Testing", "A/B Experiments", "P-Max Scaling"]
  }
];
