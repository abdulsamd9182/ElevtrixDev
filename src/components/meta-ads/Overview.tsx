...
const stats = [
  { label: "Average ROAS", value: 4.5, suffix: "x", icon: TrendingUp },
  { label: "Conv. Uplift", value: 35, suffix: "%+", icon: Zap },
  { label: "Ad Managed", value: 10, suffix: "M+", icon: Layers },
  { label: "Growth Awards", value: 15, suffix: "+", icon: Trophy }
];

const features = [
  {
    title: "Precision Targeting",
    description: "Laser-focused campaigns targeting behaviors, interests, and pinpoint demographics with absolute accuracy.",
    icon: Target,
    color: "from-blue-500 to-cyan-500"
  },
  {
    title: "Data-Driven Scaling",
    description: "Relentless A/B testing and algorithmic scaling to ensure maximum ROAS stability and vertical growth.",
    icon: BarChart3,
    color: "from-purple-500 to-pink-500"
  },
  {
    title: "Advanced Retargeting",
    description: "Capturing warm leads with dynamic catalog ads and customized multi-touch cadences for maximum lifetime value.",
    icon: RefreshCcw,
    color: "from-green-500 to-emerald-500"
  },
  {
    title: "Full Attribution",
    description: "Deploying Meta Pixel and Conversions API for absolute attribution accuracy and machine learning optimization.",
    icon: PieChart,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-gray-500 text-base md:text-lg leading-relaxed mb-8 max-w-lg mx-auto lg:mx-0">
              We engineer hyper-profitable Meta advertising ecosystems. By combining scroll-stopping creative execution with ruthless, machine-learning-driven media buying.
            </p>
