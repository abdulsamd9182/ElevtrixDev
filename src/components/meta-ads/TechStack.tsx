...
const stacks = [
  {
    category: "Ad Platforms & Placement",
    items: ["Meta Ads Manager", "Business Manager", "Instagram Ads", "WhatsApp Ads", "Audience Network"],
    icon: TrendingUp,
    color: "from-blue-500 to-indigo-500",
    expertise: 98,
    description: "Mastering the entire Meta advertising ecosystem. We design complex campaign architectures and placements that reach your ideal customers across all Meta platforms.",
    technologies: ["Advantage+ Campaigns", "Dynamic Creative", "Ad Sets Structuring", "Bidding Strategies", "Placement Optimization"],
    stats: { projects: "150+", experience: "7+ years" }
  },
  {
    category: "Tracking & Intelligence",
    items: ["Meta Pixel", "Conversions API (CAPI)", "GA4", "GTM", "Looker Studio"],
    icon: PieChart,
    color: "from-purple-500 to-pink-500",
    expertise: 95,
    description: "Data-driven tracking and server-side attribution. We ensure absolute accuracy in measurement, allowing Meta's algorithms to optimize for real business outcomes.",
    technologies: ["Server-Side GTM", "Custom Event Tracking", "Offline Conversions", "Attribution Modeling", "Data Visualization"],
    stats: { projects: "85+", experience: "6+ years" }
  },
  {
    category: "Creative & Content",
    items: ["Premiere Pro", "CapCut", "Canva Pro", "After Effects", "Figma"],
    icon: PenTool,
    color: "from-green-500 to-emerald-500",
    expertise: 90,
    description: "High-performance creative execution. We produce scroll-stopping assets engineered for short-form mobile consumption and high direct-response conversion.",
    technologies: ["UGC Production", "Motion Graphics", "Static Hook Design", "Video Editing", "Ad Copywriting"],
    stats: { projects: "200+", experience: "5+ years" }
  },
  {
    category: "E-Commerce & Scale",
    items: ["Shopify", "WooCommerce", "BigCommerce", "Klaviyo", "Hyros"],
    icon: Workflow,
    color: "from-yellow-500 to-orange-500",
    expertise: 92,
    description: "Full-funnel integration and scalability. We seamlessly bridge the gap between ad click and final sale through deep platform integrations and CRM syncing.",
    technologies: ["Catalog Integration", "Pixel Syncing", "Funnel Building", "Post-Purchase Tracking", "Scaling Algothrims"],
    stats: { projects: "110+", experience: "6+ years" }
  }
];
