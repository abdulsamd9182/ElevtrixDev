...
export default function Hero() {
  return (
    <section className="relative w-full min-h-screen pt-40 pb-24 overflow-hidden bg-white flex items-start">
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-16 z-10 w-full">
        ...
        >
          ...
          >
            We ensure high-performance, enterprise-grade digital solutions that guarantee flawless user experiences and drive business revenue.
          </motion.p>
