...
import { Target, ShieldCheck, Zap, Activity } from "lucide-react";
...
const features = [
  {
    ...
    description: "Leveraging Selenium, Cypress, and Playwright for reliable test coverage.",
    icon: Target,
    color: "from-blue-500 to-cyan-500",
  },
  {
    title: "Manual Testing",
    description: "Thorough exploratory testing to catch edge cases automation misses.",
    icon: ShieldCheck,
          ...
          >
            ...
            <div className="text-3xl md:text-4xl font-bold tracking-tight text-gray-900 leading-[1.2] mb-6">
              ...
              <span className="text-blue-600">
                DIGITAL FLAWLESSNESS
              </span>
            </div>

            <p className="text-gray-500 text-base md:text-lg leading-relaxed mb-8 max-w-lg">
              We don't just find bugs; we engineer high-quality digital
              ecosystems. Our approach combines meticulous testing execution with
              strategic quality planning.
            </p>

            <div className="flex gap-6">
              <Counter value="99.9" label="Bug-Free Rate" />
              <Counter value="50" label="Faster Release" />
            </div>
          </motion.div>
