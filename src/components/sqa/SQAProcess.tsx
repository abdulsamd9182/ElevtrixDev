...
const processSteps = [
  {
    ...
    description: "We analyze your business objectives, software architecture, and user journeys. This lets us formulate a comprehensive test strategy that aligns with your specific risk profile.",
    icon: Search,
    color: "from-blue-500 to-cyan-500",
    deliverables: ["Test Strategy Document", "Risk Assessment", "Resource Allocation", "QA Timeline"]
  },
  {
    step: "02",
    title: "Test Case Design",
    description: "Our QA engineers translate requirements into detailed, executing test cases and behavioral scenarios, ensuring maximum test coverage across both happy paths and edge cases.",
    icon: PenTool,
    color: "from-purple-500 to-pink-500",
    deliverables: ["Test Cases Repository", "Test Data Generation", "Automation Framework Setup", "Traceability Matrix"]
  },
  {
    step: "03",
    title: "Execution & Automation",
    description: "We execute manual exploratory tests and build automated scripts concurrently. Bugs are accurately triaged, documented with reproduction steps, and integrated into your issue tracker.",
    icon: Code2,
    color: "from-green-500 to-emerald-500",
    deliverables: ["Automated Test Scripts", "Defect Reports", "Performance Metrics", "Security Vulnerability Log"]
  },
  {
    step: "04",
    title: "Reporting & Sign-off",
    description: "We provide comprehensive quality metrics and go/no-go recommendations. Post-launch, we maintain automation suites and monitor production systems for continued stability.",
    icon: Rocket,
    color: "from-orange-500 to-red-500",
    deliverables: ["Final QA Sign-off", "Continuous Integration Pipelines", "Regression Suite Maintenance", "Post-Release Audits"]
  }
];
    ...
    <section ref={sectionRef} className="relative w-full py-24 bg-white overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 md:px-8 z-10">
        ...
        >
          ...
          >
            A systematic, data-driven approach to guarantee software reliability before release
          </motion.p>
        </motion.div>
