...
const stacks = [
  {
    ...
    items: ["Selenium", "Cypress", "Playwright", "Appium", "Puppeteer", "TestCafe", "Robot Framework", "Cucumber"],
    icon: Code2,
    color: "from-blue-500 to-cyan-500",
    expertise: 95,
    description: "Building robust, maintainable automated test suites for web, mobile, and desktop applications. We integrate seamlessly with CI/CD pipelines.",
    technologies: ["Selenium", "Cypress", "Playwright", "Appium", "JUnit", "TestNG", "Mocha"],
  ...
  },
  {
    ...
    expertise: 88,
    description: "Validating business logic, data integrity, and complex microservice interactions. We ensure your backend architecture is solid and secure.",
    ...
    <section ref={sectionRef} className="relative w-full py-24 bg-white overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 md:px-8 z-10">
        ...
        >
          ...
          >
            We leverage industry-leading tools and custom frameworks to ensure maximum test coverage and reliability.
          </motion.p>
        </motion.div>
