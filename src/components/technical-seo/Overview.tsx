...
const stats = [
  { label: "Load Velocity", value: 98, suffix: "%", icon: Zap },
  { label: "Crawl Efficiency", value: 99, suffix: "%", icon: Search },
  { label: "Indexing Rate", value: 100, suffix: "%", icon: Activity },
  { label: "Core Web Vitals", value: 100, suffix: "", icon: Gauge },
];

const features = [
  {
    title: "Server-Side Optimization",
    description: "Engineering advanced cache layers and SSR architectures to minimize TTFB and maximize crawl budget efficiency.",
    icon: Server,
    color: "from-emerald-500 to-teal-500"
  },
  {
    title: "Infrastructure Scaling",
    description: "Configuring edge networks and CDN strategies that deliver instantaneous content across global nodes.",
    icon: Terminal,
    color: "from-cyan-500 to-blue-500"
  },
  {
    title: "Core Web Vitals Mastery",
    description: "Surgical optimization of LCP, FID, and CLS through code splitting and asset prioritization frameworks.",
    icon: Gauge,
    color: "from-teal-500 to-emerald-500"
  },
  {
    title: "Real-Time Indexing",
    description: "Automated indexing pipelines that alert search engine bots to content updates in milliseconds.",
    icon: Activity,
          ...
          <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-5">
            {features.map((feature, idx) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="group p-6 bg-white border border-gray-100 rounded-2xl shadow-sm hover:border-emerald-100 hover:shadow-xl transition-all duration-500"
              >
