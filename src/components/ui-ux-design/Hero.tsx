...
export default function Hero() {
  return (
    <section className="relative w-full min-h-screen pb-24 overflow-hidden bg-white flex items-center md:items-start md:pt-40">
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-16 z-10 w-full">
        ...
        >
          ...
          >
            We build high-performance, enterprise-grade digital solutions that transform user engagement into business revenue through empathy-first design.
          </motion.p>
