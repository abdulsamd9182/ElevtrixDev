...
const industries = [
  {
    ...
    description: "Designing secure, trustworthy interfaces that build instant user confidence while simplifying complex financial data.",
    icon: Banknote,
    color: "from-blue-600 to-indigo-600",
    stats: "99% Trust Score"
  },
  {
    name: "E-Commerce",
    description: "Optimizing checkout flows and product discovery to maximize conversion rates and reduce user friction effectively.",
    icon: ShoppingBag,
    color: "from-purple-600 to-pink-600",
    stats: "45% Conv. Uplift"
  },
  {
    name: "SaaS & Enterprise",
    description: "Complex B2B dashboards requiring simplified, powerful user navigation and efficient data visualization systems.",
    icon: Building2,
    color: "from-emerald-600 to-teal-600",
    stats: "60% Task Efficiency"
  },
  {
    name: "EdTech Platforms",
    description: "Creating engaging and intuitive learning environments that foster focus and knowledge retention for all age groups.",
    icon: GraduationCap,
  ...
  {
    name: "Digital Health",
    description: "Accessible, compliant interfaces prioritizing readability and patient empathy for critical medical applications.",
    icon: HeartPulse,
    color: "from-red-600 to-rose-600",
    stats: "AA Accessibility"
  }
];
    ...
    <section ref={sectionRef} className="relative w-full py-24 bg-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-8 md:px-16 z-10">
        ...
        >
          ...
          >
            Specialized design expertise across diverse industry landscapes, delivering high-impact digital experiences.
          </motion.p>
        </motion.div>
