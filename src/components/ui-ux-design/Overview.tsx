...
const stats = [
  { label: "User Satisfaction", value: 98, suffix: "%", icon: Users },
  { label: "Conversion Lift", value: 45, suffix: "%+", icon: Zap },
  { label: "Design Systems", value: 100, suffix: "+", icon: Layers },
  { label: "Awards Won", value: 25, suffix: "+", icon: Trophy }
];

const features = [
  {
    title: "Empathy-First Research",
    description: "Deep user behavior analysis and persona mapping to ensure the product solves real-world human problems.",
    icon: Compass,
    color: "from-blue-500 to-cyan-500"
  },
  {
    title: "Strategy & Architecture",
    description: "Structuring complex data into intuitive, friction-free journeys that guide users toward their goals seamlessly.",
    icon: Layout,
    color: "from-purple-500 to-pink-500"
  },
  {
    title: "Visual Excellence",
    description: "Stunning, pixel-perfect interfaces that elevate brand perception and create emotional connections.",
    icon: Palette,
    color: "from-green-500 to-emerald-500"
  },
  {
    title: "Rapid Prototyping",
    description: "High-fidelity, interactive prototypes to validate assumptions and gather user feedback at lightning speed.",
