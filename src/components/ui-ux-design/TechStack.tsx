...
const stacks = [
  {
    ...
    items: ["Figma", "Sketch", "Framer", "Adobe XD", "ProtoPie"],
    icon: Figma,
    color: "from-blue-500 to-indigo-500",
    expertise: 98,
    description: "Industry-leading design and high-fidelity prototyping. We create complex architectural systems and interactive flows that mirror real products.",
    technologies: ["Figma Variables", "Auto Layout 5.0", "Advanced Prototyping", "Component Libraries", "Design Systems"],
    stats: { projects: "100+", experience: "8+ years" }
  },
  {
    category: "User Research & Strategy",
    items: ["Maze", "Hotjar", "UserTesting", "Lookback", "Miro"],
    icon: Search,
    color: "from-purple-500 to-pink-500",
    expertise: 92,
    description: "Data-driven research and usability testing. We uncover user pain points and behavior patterns through rigorous analysis and feedback loops.",
    technologies: ["Maze Testing", "Heatmaps", "User Interviews", "Persona Mapping", "A/B Testing"],
    stats: { projects: "45+", experience: "6+ years" }
  },
  {
    category: "Motion & Interaction",
    items: ["After Effects", "Lottie", "Principle", "Spline", "GSAP"],
    icon: Zap,
    color: "from-green-500 to-emerald-500",
    expertise: 88,
    description: "Dynamic micro-interactions and spatial design. We add life to products through smooth transitions, Lottie animations, and 3D interactions.",
    technologies: ["LottieFiles", "3D Spline", "Micro-interactions", "Transition Design", "After Effects"],
    stats: { projects: "30+", experience: "5+ years" }
  },
  {
    category: "Handoff & Execution",
    items: ["Zeplin", "Storybook", "Abstract", "FigJam", "Jira"],
    icon: Command,
    color: "from-yellow-500 to-orange-500",
    expertise: 95,
    description: "Seamless design-to-development workflows. We ensure pixel-perfect delivery through comprehensive documentation and component handoff.",
    technologies: ["Design Tokens", "Storybook Sync", "Detailed Specs", "Version Control", "Collaboration"],
    stats: { projects: "80+", experience: "7+ years" }
  }
];
    ...
    <section ref={sectionRef} className="relative w-full py-24 bg-white overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 md:px-8 z-10">
        ...
        >
          ...
          >
            A high-fidelity toolkit curated for building industry-leading digital experiences
          </motion.p>
        </motion.div>
