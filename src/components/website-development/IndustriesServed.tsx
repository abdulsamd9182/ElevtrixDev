...
const industries = [
  {
    ...
    description: "Custom LMS and e-learning platforms designed for knowledge democratization. Interactive courses, virtual classrooms, and progress tracking.",
    icon: GraduationCap,
  ...
  },
  {
    ...
    description: "Scalable custom e-commerce stores and high-performance PWAs with seamless checkout, inventory management, and mobile optimization.",
    icon: ShoppingBag,
  ...
  {
    name: "Healthcare",
    description: "Secure patient portals and telemedicine platforms with HIPAA compliance focus. Appointment scheduling, EHR integration, and video consultations.",
    icon: HeartPulse,
  ...
  },
  {
    ...
    description: "Advanced tracking systems and warehouse management solutions with real-time updates, route optimization, and inventory control.",
    icon: Truck,
  ...
  },
  {
    ...
    description: "Secure banking portals and seamless payment integration systems with fraud detection, compliance, and real-time analytics.",
    icon: Banknote,
    ...
    <section ref={sectionRef} className="relative w-full py-24 bg-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-16 z-10">
        ...
        >
          ...
          >
            Delivering specialized web development services tailored to the unique demands of diverse sectors.
          </motion.p>
        </motion.div>
