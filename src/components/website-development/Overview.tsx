...
const features = [
  {
    ...
    description: "Leveraging React, Next.js, Node.js, and Python for robust solutions.",
    icon: Globe,
    color: "from-blue-500 to-cyan-500",
  },
  {
    title: "Responsive Design",
    description: "Seamless performance and visual integrity across all modern devices.",
    icon: Smartphone,
    color: "from-purple-500 to-pink-500",
  },
  {
    title: "Performance Optimization",
    description: "Ultra-fast load speeds through CDN integration and lazy loading.",
    icon: Zap,
    color: "from-yellow-500 to-orange-500",
  },
  {
    title: "Web Security",
    description: "Hardened security with SSL, enterprise firewalls, and regular audits.",
    icon: ShieldCheck,
