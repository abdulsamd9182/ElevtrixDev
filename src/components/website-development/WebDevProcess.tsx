...
const processSteps = [
  {
    ...
    description: "We dive deep into your business goals, target audience, and project requirements. Our team conducts thorough research and creates a detailed roadmap for your project.",
    icon: Search,
    color: "from-blue-500 to-cyan-500",
    deliverables: ["Requirements Analysis", "Market Research", "Technical Specifications", "Project Timeline"]
  },
  {
    step: "02",
    title: "Design & Prototyping",
    description: "Our designers create stunning, user-centric interfaces with interactive prototypes. We iterate based on your feedback until the design perfectly matches your vision.",
    icon: PenTool,
  ...
  },
  {
    ...
    description: "Our developers bring the design to life using cutting-edge technologies. We follow best practices for clean code, performance optimization, and thorough testing.",
    icon: Code2,
    color: "from-green-500 to-emerald-500",
    deliverables: ["Frontend Development", "Backend Integration", "Database Setup", "QA Testing"]
  },
  {
    step: "04",
    title: "Launch & Support",
    description: "We deploy your website with zero downtime and provide ongoing maintenance, security updates, and performance monitoring to ensure long-term success.",
    icon: Rocket,
    color: "from-orange-500 to-red-500",
    deliverables: ["Deployment", "Performance Optimization", "24/7 Monitoring", "Ongoing Support"]
  }
];
    ...
    <section ref={sectionRef} className="relative w-full py-24 bg-white overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 md:px-8 z-10">
        ...
        >
          ...
          >
            A systematic approach to deliver high-quality, scalable web solutions
          </motion.p>
        </motion.div>
